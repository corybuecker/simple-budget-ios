...
xcrun simctl launch --console-pty --terminate-running-process MyPhone dev.corybuecker.simple-budget -com.apple.CoreData.CloudKitDebug 0 -com.apple.CoreData.Logging.stderr 0
